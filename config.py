...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5545657080:AAE-_QuyV8xw2Bz4eyRLwwcilsXfXQlz4tw' # Get it from https://t.me/BotFather
    APP_ID = '28159078' # Get it from my.telegram.org/apps
    API_HASH = '6bbe83e337b138c9ba6994497d9cf3c0' # Get it from my.telegram.org/apps
